...
- [BeeGFS](https://www.beegfs.io/c/) - is designed to provide scalable, high-throughput access to file storage systems, making it particularly well-suited for use in HPC and AI environments.

Management Platforms / Monitors:
...
6. Demonstrate proper configuration by utilizing features provided by the software
    - Given the scope of allowed software, I am keeping this vague, so here are some examples:
        - BeeGFS - users can connect to storage cluster and interact (save / access files)
