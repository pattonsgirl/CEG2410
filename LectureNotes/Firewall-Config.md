...
1. Finish setting up the customer network
    ...
    > ![WARNING] Delete when not in use! Money pit - does not turn off when lab environment is off
...
> ![WARNING]We are hamstrung here because our only access to the customer device is with SSH...
